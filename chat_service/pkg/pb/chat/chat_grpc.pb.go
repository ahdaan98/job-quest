...
func (c *chatServiceClient) GetFriendChat(ctx context.Context, in *GetFriendChatRequest, opts ...grpc.CallOption) (*GetFriendChatResponse, error) {
	...
	err := c.cc.Invoke(ctx, ChatService_GetFriendChat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) GroupMessage(ctx context.Context, in *GroupMessageRequest, opts ...grpc.CallOption) (*GroupMessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, ChatService_GroupMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) GetGroupChat(ctx context.Context, in *GetGroupChatRequest, opts ...grpc.CallOption) (*GetGroupChatResponse, error) {
	...
	err := c.cc.Invoke(ctx, ChatService_GetGroupChat_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
