...
const (
	...
	Job_UpdateApplyJob_FullMethodName      = "/job.Job/UpdateApplyJob"
	Job_GetApplicants_FullMethodName       = "/job.Job/GetApplicants"
)
...
type JobClient interface {
	...
	UpdateApplyJob(ctx context.Context, in *UpdateApplyJobRequest, opts ...grpc.CallOption) (*UpdateApplyJobResponse, error)
	GetApplicants(ctx context.Context, in *GetAcceptedApplicantsRequest, opts ...grpc.CallOption) (*GetAcceptedApplicantsResponse, error)
}
...
func (c *jobClient) PostJob(ctx context.Context, in *JobOpeningRequest, opts ...grpc.CallOption) (*JobOpeningResponse, error) {
	...
	err := c.cc.Invoke(ctx, Job_PostJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobClient) GetAllJobs(ctx context.Context, in *GetAllJobsRequest, opts ...grpc.CallOption) (*GetAllJobsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Job_GetAllJobs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobClient) GetAJob(ctx context.Context, in *GetAJobRequest, opts ...grpc.CallOption) (*JobOpeningResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(JobOpeningResponse)
	err := c.cc.Invoke(ctx, Job_GetAJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobClient) DeleteAJob(ctx context.Context, in *DeleteAJobRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Job_DeleteAJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobClient) UpdateAJob(ctx context.Context, in *UpdateAJobRequest, opts ...grpc.CallOption) (*UpdateAJobResponse, error) {
	...
	err := c.cc.Invoke(ctx, Job_UpdateAJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobClient) JobSeekerGetAllJobs(ctx context.Context, in *JobSeekerGetAllJobsRequest, opts ...grpc.CallOption) (*JobSeekerGetAllJobsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Job_JobSeekerGetAllJobs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobClient) GetJobDetails(ctx context.Context, in *GetJobDetailsRequest, opts ...grpc.CallOption) (*GetJobDetailsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Job_GetJobDetails_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobClient) GetJobApplications(ctx context.Context, in *GetJobApplicationsRequest, opts ...grpc.CallOption) (*GetJobApplicationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Job_GetJobApplications_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobClient) SaveJobs(ctx context.Context, in *SaveJobRequest, opts ...grpc.CallOption) (*SaveJobResponse, error) {
	...
	err := c.cc.Invoke(ctx, Job_SaveJobs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobClient) DeleteSavedJob(ctx context.Context, in *DeleteSavedJobRequest, opts ...grpc.CallOption) (*DeleteSavedJobResponse, error) {
	...
	err := c.cc.Invoke(ctx, Job_DeleteSavedJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobClient) GetSavedJobs(ctx context.Context, in *GetSavedJobsRequest, opts ...grpc.CallOption) (*GetSavedJobsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Job_GetSavedJobs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobClient) UpdateApplyJob(ctx context.Context, in *UpdateApplyJobRequest, opts ...grpc.CallOption) (*UpdateApplyJobResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateApplyJobResponse)
	err := c.cc.Invoke(ctx, Job_UpdateApplyJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *jobClient) GetApplicants(ctx context.Context, in *GetAcceptedApplicantsRequest, opts ...grpc.CallOption) (*GetAcceptedApplicantsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAcceptedApplicantsResponse)
	err := c.cc.Invoke(ctx, Job_GetApplicants_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type JobServer interface {
	...
	UpdateApplyJob(context.Context, *UpdateApplyJobRequest) (*UpdateApplyJobResponse, error)
	GetApplicants(context.Context, *GetAcceptedApplicantsRequest) (*GetAcceptedApplicantsResponse, error)
...
func (UnimplementedJobServer) DeleteAJob(context.Context, *DeleteAJobRequest) (*emptypb.Empty, error) {
...
func (UnimplementedJobServer) UpdateApplyJob(context.Context, *UpdateApplyJobRequest) (*UpdateApplyJobResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateApplyJob not implemented")
}
func (UnimplementedJobServer) GetApplicants(context.Context, *GetAcceptedApplicantsRequest) (*GetAcceptedApplicantsResponse, error) {
...
func _Job_UpdateApplyJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateApplyJobRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(JobServer).UpdateApplyJob(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Job_UpdateApplyJob_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JobServer).UpdateApplyJob(ctx, req.(*UpdateApplyJobRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Job_GetApplicants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAcceptedApplicantsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(JobServer).GetApplicants(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Job_GetApplicants_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(JobServer).GetApplicants(ctx, req.(*GetAcceptedApplicantsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Job_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateApplyJob",
			Handler:    _Job_UpdateApplyJob_Handler,
		},
		{
			MethodName: "GetApplicants",
			Handler:    _Job_GetApplicants_Handler,
		},
	},
